...
export const Logistics: React.FC = () => {
  ...
  const Button: React.FC<{ variant: 'primary' | 'outline'; children: React.ReactNode }> = ({
    variant,
    children,
  }) => {
            ...
            {deliveries.map((d, idx) => (
              <div key={idx} className="border border-gray-200 rounded-lg p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  {d.badge && (
                    <span className={`text-xs font-medium px-2 py-1 rounded ${d.badge.color}`}>
                      {d.badge.text}
                    </span>
                  )}
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900">{d.dropoff.name}</p>
